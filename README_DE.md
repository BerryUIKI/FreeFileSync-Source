...
- **GitHub Releases (Automatische Builds)**: [https://github.com/BerryUIKI/FreeFileSync-Source/releases](https://github.com/BerryUIKI/FreeFileSync-Source/releases)
...
## Vorkompilierte Releases & CI/CD

Automatische Multi-Architektur-Builds (Linux `x86_64` und `aarch64` / ARM64) sowie Quellcode-Archive werden kontinuierlich über GitHub Actions erstellt.

Vorkompilierte portable Pakete stehen unter [GitHub Releases](https://github.com/BerryUIKI/FreeFileSync-Source/releases) zum Download bereit. Jedes Release enthält eigenständige Binärdateien, Startskripte, Ressourcen und SHA-256-Prüfsummen.
